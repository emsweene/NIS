...
load('5_2008_output.RData')
index_it_5 <- index_it_5_2008
load('433_2008_output.RData')
index_433 <- index_it_109_2008 
load('434_2008_output.RData')
index_434 <- index_it_109_2008
load('436_2008_output.RData')
index_436 <- index_it_109_2008 
load('9910_2008_output.RData')
index_it_9910 <-  index_it_99_2008
...
RACE <- apply(ais_stroke, 2 , function(x) substr(x, start = 482, stop = 483))
...
FEMALE <- apply(ais_stroke, 2 , function(x) substr(x, start = 226, stop = 227))
LOS <- apply(ais_stroke, 2 , function(x) substr(x, start = 254, stop = 258))
Year <- rep(2008, length(ais_stroke))

#########################################################################################################################
## Create and save dataframe 
#########################################################################################################################

data_2008 <- data.frame(hiv, tpa, Other_Diagnosis_1, Other_Diagnosis_2, Other_Diagnosis_3, Other_Diagnosis_4,
...
save(data_2008, file = 'ais_stroke_2008.RData') 